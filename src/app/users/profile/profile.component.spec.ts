...
describe('ProfileComponent Tests', () => {
    ...
    let userDataService;
    let notificator;
    let component = new ProfileComponent(userDataService, notificator);
    ...
    describe('ngOnInit Tests', () => {
        beforeEach(() => {
            ...
            component = new ProfileComponent(userDataService, notificator);
        });

        it('Expect to call userDataService getCurrentUserInfo method once and subscribe once', () => {
            component.ngOnInit();
